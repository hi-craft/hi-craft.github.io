...
<tr>
    <th></th>
    <th align="right">window.onload</th>
...
<tr>
    <td>执行时机</td>
    <td align="right">必须等待网页内的所有内容加载<br>完毕之后(包括图片)才能执行</td>
    <td>网页中所有dom结构绘制完毕后就执行,可能dom元素<br>关联的东西没有加载完</td>
</tr>
<tr>
    <td>编写个数</td>
    <td align="right">不能同时编写多个</td>
    <td>能同时编写多个</td>
</tr>
<tr>
    <td>简化语法</td>
    <td align="right">无</td>
    <td>$(document).ready(function(){<br>//....<br>});<br>可以简写成$(document).ready(function   (){<br>//....<br>})</td>
</tr>
</tbody>
</table>
